<img alt="Estaterally logo" src="https://i.snag.gy/FAgp8K.jpg" width="200">

[![CircleCI](https://circleci.com/gh/EstaterallyOrg/Estaterally-www.svg?style=svg)](https://circleci.com/gh/EstaterallyOrg/Estaterally-www) [![gitmoji badge](https://img.shields.io/badge/gitmoji-%20😜%20😍-FFDD67.svg?style=flat-square)](https://github.com/carloscuesta/gitmoji)

The code for [about.Estaterally.io](https://about.Estaterally.io).
...
Please read and follow our [Code of Conduct](https://github.com/EstaterallyOrg/Estaterally-www/blob/master/CODE_OF_CONDUCT.md).
...
Please read carefully [our license](https://github.com/EstaterallyOrg/Estaterally-www/raw/master/LICENSE.txt) and ask us if you have any questions.
...
```sh
git clone git@github.com:EstaterallyOrg/Estaterally-www.git
```
