            ...
            <div class="box step-container">
                <div v-if="stepNumber === 1">
                    <div class="columns is-mobile is-multiline">
                        <div class="column is-12 has-text-centered">
                            <button
                                class="button is-success is-large is-outlined app-logo is-rounded"
                                disabled
                            >
                ...
                <div v-else-if="stepNumber === 2" class="second-step">
                    <div class="columns is-multiline is-centered">
                        <div class="column is-12 has-text-centered">
                            <button
                                class="button is-success is-large is-outlined app-logo"
                                disabled
                            >
                                <i class="fas fa-music app-logo__icon"></i>
                            </button>
                        ...
                        <div
                            v-if="customOptionalDataSharingEnabled"
                            class="column is-9"
                        >
                            <div class="field">
                                <b-checkbox
                                    size="is-medium"
                                    v-model="optionalDataSharingEnabled"
                                >
                                    <div
                                        class="is-size-7"
                                        v-html="optionalEnabledDataString"
                                    ></div>
                                </b-checkbox>
                            </div>
                        </div>
                        ...
                        <div class="column is-12 has-text-centered">
                            <b-collapse :open.sync="inspectDataOpen">
                                <button
                                    class="button is-transparent is-size-7 is-borderless"
                                    slot="trigger"
                                >
                                    <span>
                                        {{ songipy("inspect") }}
                                        ...
                                        <p v-for="dataItem of sharedData">
                                            ...
                                            >
                                                <span>
                                                    {{
                                                        $t(
                                                            "manifesto:manifesto.examples.common.open_list"
                                                        )
                                                    }}
                                                    ↗
                                                </span>
                                            ...
                                            >
                                                <span>
                                                    {{
                                                        $t(
                                                            "manifesto:manifesto.examples.common.open_image"
                                                        )
                                                    }}
                                                    ↗
                                                </span>
                            ...
                            <div class="columns is-mobile">
                                <div class="column is-6">
                                    ...
                                    >
                                        {{
                                            $t(
                                                "manifesto:manifesto.examples.common.btn_cancel"
                                            )
                                        }}
                                    </button>
                                </div>
                                <div class="column is-6">
                                    <button
                                        class="button is-rainbow is-medium"
                                        @click="goToStep4()"
                                    >
                                        {{
                                            $t(
                                                "manifesto:manifesto.examples.common.btn_continue"
                                            )
                                        }}
                                    </button>
                                </div>
                ...
                <div v-else-if="stepNumber === 3">
                    <div class="columns is-mobile is-multiline is-marginless">
                            ...
                            <div class="columns">
                                <div class="column is-narrow">
                                    <button class="button" @click="goToStep2()">
                                        ...
                                        <span>{{
                                            $t(
                                                "manifesto:manifesto.examples.common.btn_back"
                                            )
                                        }}</span>
                                    </button>
                                </div>
                        ...
                        <div class="columns is-mobile is-multiline data-items">
                            <div
                                class="column is-12 data-item"
                                v-for="dataItem of availableData"
                            >
                                <div class="columns is-mobile">
                                    <div class="column is-10">
                                        <div
                                            class="is-size-6"
                                            @click="wantsToToggleItem(dataItem)"
                                        >
                                            <strong>{{
                                                dataItem.readableName
                                            }}</strong>
                                            <span v-if="dataItem.required">
                                                {{
                                                    $t(
                                                        "manifesto:manifesto.examples.common.required"
                                                    )
                                                }}</span
                                            >
                                        </div>
                        ...
                        <div class="column is-12 has-text-centered">
                            <div>
                                <strong>
                                    {{
                                        $t(
                                            "manifesto:manifesto.examples.common.success"
                                        )
                                    }}
                                </strong>
                            </div>
                            <span>
                                {{ songipy("Estaterally_has_shared") }}
                            </span>
                        </div>
                        <div class="column is-12 has-text-centered">
...
export default {
    ...
    data() {
        return {
            ...
            availableData: [
                {
                    readableName: this.$t(
                        "manifesto:manifesto.examples.can_receive_following_data.name"
                    ),
                    name: "name",
                    type: "text",
                ...
                {
                    readableName: this.$t(
                        "manifesto:manifesto.examples.can_receive_following_data.email"
                    ),
                    name: "email",
                    type: "text",
                ...
                {
                    readableName: this.$t(
                        "manifesto:manifesto.examples.can_receive_following_data.profile_picture"
                    ),
                    name: "profile_picture",
                    type: "image",
                    value:
                        "https://vignette.wikia.nocookie.net/pulpfiction/images/b/b6/Jules.jpg/revision/latest?cb=20090501131406",
                    required: false,
                    enabled: false
                },
                {
                    readableName: this.$t(
                        "manifesto:manifesto.examples.can_receive_following_data.age_range"
                    ),
                    name: "age_range",
                    type: "text",
                    value: "35-40",
                ...
                {
                    readableName: this.$t(
                        "manifesto:manifesto.examples.can_receive_following_data.gender"
                    ),
                    name: "gender",
                    type: "text",
                ...
                {
                    readableName: this.$t(
                        "manifesto:manifesto.examples.can_receive_following_data.language"
                    ),
                    name: "language",
                    type: "text",
                ...
                {
                    readableName: this.$t(
                        "manifesto:manifesto.examples.can_receive_following_data.country_of_birth"
                    ),
                ...
                {
                    readableName: this.$t(
                        "manifesto:manifesto.examples.can_receive_following_data.friends"
                    ),
                    name: "friends_list",
                    type: "list",
                    value: [],
                ...
                {
                    readableName: this.$t(
                        "manifesto:manifesto.examples.can_receive_following_data.birthday"
                    ),
                    name: "birthday",
                    type: "text",
                ...
                {
                    readableName: this.$t(
                        "manifesto:manifesto.examples.can_receive_following_data.likes"
                    ),
                    name: "user_likes",
                    type: "list",
                    value: [],
    ...
    computed: {
        ...
        requiredSharedDataString() {
            return this.$t(
                "manifesto:manifesto.examples.songipy.in_order_to_continue",
                {
                    required_data: concatenate(
                        this.requiredSharedData,
                        "readableName",
                        this.$t("manifesto:manifesto.examples.common.last_item")
                    )
                }
            );
        },
        optionalDataString() {
            return this.$t("manifesto:manifesto.examples.songipy.optionally", {
                optional_data: concatenate(
                    this.optionalSharedData,
                    "readableName",
                    this.$t("manifesto:manifesto.examples.common.last_item")
                )
            });
        ...
        optionalEnabledDataString() {
            return this.$t("manifesto:manifesto.examples.songipy.optionally", {
                optional_data: concatenate(
                    this.enabledOptionalSharedData,
                    "readableName",
                    this.$t("manifesto:manifesto.examples.common.last_item")
                )
            });
    ...
    methods: {
        ...
        songipy(str) {
            return this.$t(`manifesto:manifesto.examples.songipy.${str}`);
        },
        ...
        wantsToLearnMoreAboutSecureApps() {
            this.$dialog.alert({
                message: this.$t(
                    "manifesto:manifesto.examples.songipy.safe_app_modal"
                ),
                confirmText: this.$t(
                    "manifesto:manifesto.examples.common.btn_got_it"
                )
            });
        },
        wantsToDisplayListWithName(name) {
            const message = this.$t(
                "manifesto:manifesto.examples.songipy.list_modal",
                { data_name: name }
            );
            this.$dialog.alert({
                message,
