        ...
        <form class="column is-12" @submit.prevent="onSubmit()">
            ...
            <div class="field padding-bottom-3x">
                <label class="label" for="message">
                    {{ $t("contact:message.user_message") }}</label
                >
                    ...
                    <div class="field">
                        <div class="control">
                            <textarea
                                ...
                                :placeholder="
                                    $t(
                                        'contact:message.user_message_placeholder'
                                    )
                                "
                                style="resize: none;"
                                id="message"
            ...
            <div
                class="padding-top-2x padding-bottom-2x"
                v-if="!acceptedRecaptcha"
            >
                <div class="columns">
                    <div class="column">
                            ...
                            <div class="columns is-mobile is-multiline">
                                <div class="column is-12">
                                    <p
                                        v-html="
                                            $t(
                                                'contact:message.google_recaptcha_title'
                                            )
                                        "
                                    ></p>
                                    <br />
                                    ...
                                    <ul>
                                        <li>
                                            {{
                                                $t(
                                                    "contact:message.info_ip_location"
                                                )
                                            }}
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            {{
                                                $t(
                                                    "contact:message.info_mouse_clicks"
                                                )
                                            }}
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            {{
                                                $t(
                                                    "contact:message.info_browser_lang"
                                                )
                                            }}
                                        </li>
                                        <li>
                                    ...
                                    {{
                                        $t(
                                            "contact:message.recaptcha_authorization"
                                        )
                                    }}
                                </div>
                                <div class="column is-12">
                                    <button
                                        class="button is-warning is-large is-size-7-mobile is-size-6"
                                        @click="enableGoogleRecaptcha()"
                                        type="button"
                                        v-scroll-to="'#message-form'"
                                    >
                                        {{
                                            $t(
                                                "contact:message.recaptcha_authorization_yes"
                                            )
                                        }}
                                    </button>
                                </div>
                                ...
                                <div class="column is-12">
                                    ...
                                    >
                                        {{
                                            $t(
                                                "contact:message.recaptcha_authorization_no"
                                            )
                                        }}
                                    </a>
                                </div>
            ...
            <div class="field" v-else>
                <div class="control">
                    <vue-recaptcha
                        sitekey="6LcBGlsUAAAAAA6NXsqPOtUbsk_G2ov5nafyduDk"
                        ref="recaptcha"
                        v-on:verify="onCaptchaVerified($event)"
                    ></vue-recaptcha>
                </div>
                <p class="help is-danger">
...
export default {
    ...
    computed: {
        formIsValid() {
            return (
                this.errors.items.length <= 0 && this.captchaVerified === true
            );
        },
        mailToLink() {
