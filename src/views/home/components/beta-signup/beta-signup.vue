                ...
                <div class="column waitlist-container">
                    <form @submit.prevent="sendEmail" novalidate>
                        <p
                            ...
                            v-bind:class="{ submitted: emailSendClicked }"
                        >
                            <span
                                class="input-email is-rainbow"
                            ...
                            >
                                <input
                                    ...
                                    :placeholder="
                                        $t(
                                            'home:beta_container.email_placeholder'
                                        )
                                    "
                                    v-model="email"
                            ...
                            <button
                                class="join-waitlist is-rainbow"
                                type="submit"
                                v-bind:class="{ success: subscribeSuccessful }"
                            >
                                <span v-show="!emailSendClicked"
                                    ><i class="fas fa-paper-plane"></i
                                ></span>
                                <span
                                    v-show="
                                        emailSendClicked && !subscribeSuccessful
                                    "
                                    ><i class="fas fa-spinner is-loading"></i
                                ></span>
                                <span
                                    class="animated fadeIn"
                                    v-show="subscribeSuccessful"
                        ...
                        <span
                            v-show="
                                fields.email &&
                                    ...
                                    errors.has('email')
                            "
                            class="error-message has-text-danger is-size-7"
                            ><span
                                class="icon is-small is-valign-top"
                                v-twemoji
                            >
                                😕 </span
                        ...
                        <span
                            ...
                            v-show="subscribeSuccessful"
                            ><span class="icon is-small" v-twemoji>🎉</span
                            ><span
                                v-html="
                                    $t('home:beta_container.success', {
                                        count: count + 1
                                    })
                                "
                            ></span
...
const MAILCHIMP_SUBSCRIBE_URL = "http://localhost:5000/public/subscribe/";
            ...
            axios
                ...
                .catch(error => {
                    if (error.response && error.response.status === 400) {
                        ...
                        this.errorEmail = this.$t(
                            "home:beta_container.server_error"
                        );
                    }
