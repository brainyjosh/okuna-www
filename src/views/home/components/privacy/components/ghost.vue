<template>
    <div class="ghost-container">
        ...
        <svg
            ...
            x="0px"
            y="0px"
            viewBox="0 0 127.4 132.7"
            enable-background="new 0 0 127.4 132.7"
            xml:space="preserve"
        >
            <path
                fill="#EAEAEA"
                d="M116.2,125.1c1-1.2,1.3-2.7,1.4-3.7V54.8c0,0-4.6-34.9-36.1-44.4s-66,6.6-72.1,44l-0.8,63.2
	...
	s5.4,8.2,12.9,7.9s12.6-8.4,12.6-8.4s2.2-3.9,7.2,0.4s7.6,9.8,14.4,8.1C114.7,126,115.4,125.9,116.2,125.1z"
            ...
            <path
                fill="#303030"
                d="M71.9,62.8c0.1-1.1-0.8-2-1.9-2.1c-0.7,0-1.3,0.3-1.7,0.8c-0.8,0.8-2.5,2.2-4.7,2.4
	...
	C71.7,63.8,71.9,63.3,71.9,62.8z"
            ...
            <path
                ...
                stroke="#D3D3D3"
                stroke-miterlimit="10"
                d="M116.3,55.8c0-0.3-2.3-28.7-30.2-41c-7.8-3.4-15.8-5.2-23.7-5.2
